...
<html lang="en">
  ...
  <body>
            ...
            <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
              <div class="nav-item dropdown">
                <a href="#" class="nav-link" data-toggle="dropdown"
                  >Fashion <i class="fa fa-angle-down float-right mt-1"></i
                ></a>
                <div
                ...
                >
                  ...
                  <a href="" class="dropdown-item">Baby's Fashion</a>
                </div>
              </div>
          ...
          >
            ...
            >
              <div class="navbar-nav mr-auto py-0">
                <a href="home.blade.php" class="nav-item nav-link active">Home</a>
    ...
    <div class="container-fluid offer pt-5">
      <div class="row px-xl-5">
        <div class="col-md-6 pb-4">
          ...
          >
            <img src="{{asset('asset/img/offer-1.png')}}" alt="" />
        ...
        <div class="col-md-6 pb-4">
          ...
          >
            <img src="{{asset('asset/img/offer-2.png')}}" alt="" />
            <div class="position-relative" style="z-index: 1">
              <h5 class="text-uppercase text-primary mb-3">
                20% off the all order
              </h5>
      ...
      <div class="row px-xl-5 pb-3">
        <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
          <div class="card product-item border-0 mb-4">
            ...
            >
              <img class="img-fluid w-100" src="{{asset('asset/img/product-1.jpg')}}" alt="" />
            </div>
            <div
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
          <div class="card product-item border-0 mb-4">
            <div
              class="card-header product-img position-relative overflow-hidden bg-transparent border p-0"
            >
              <img class="img-fluid w-100" src="{{asset('asset/img/product-2.jpg')}}" alt="" />
            </div>
            <div
              class="card-body border-left border-right text-center p-0 pt-4 pb-3"
            >
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
          <div class="card product-item border-0 mb-4">
            <div
              class="card-header product-img position-relative overflow-hidden bg-transparent border p-0"
            >
              <img class="img-fluid w-100" src="{{asset('asset/img/product-3.jpg')}}" alt="" />
            </div>
            <div
              class="card-body border-left border-right text-center p-0 pt-4 pb-3"
            >
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
          <div class="card product-item border-0 mb-4">
            <div
              class="card-header product-img position-relative overflow-hidden bg-transparent border p-0"
            >
              <img class="img-fluid w-100" src="{{asset('asset/img/product-4.jpg')}}" alt="" />
            </div>
            <div
              class="card-body border-left border-right text-center p-0 pt-4 pb-3"
            >
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
          <div class="card product-item border-0 mb-4">
            <div
              class="card-header product-img position-relative overflow-hidden bg-transparent border p-0"
            >
              <img class="img-fluid w-100" src="{{asset('asset/img/product-5.jpg')}}" alt="" />
            </div>
            <div
              class="card-body border-left border-right text-center p-0 pt-4 pb-3"
            >
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
          <div class="card product-item border-0 mb-4">
            <div
              class="card-header product-img position-relative overflow-hidden bg-transparent border p-0"
            >
              <img class="img-fluid w-100" src="{{asset('asset/img/product-6.jpg')}}" alt="" />
            </div>
            <div
              class="card-body border-left border-right text-center p-0 pt-4 pb-3"
            >
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
          <div class="card product-item border-0 mb-4">
            <div
              class="card-header product-img position-relative overflow-hidden bg-transparent border p-0"
            >
              <img class="img-fluid w-100" src="{{asset('asset/img/product-7.jpg')}}" alt="" />
            </div>
            <div
              class="card-body border-left border-right text-center p-0 pt-4 pb-3"
            >
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
          <div class="card product-item border-0 mb-4">
            <div
              class="card-header product-img position-relative overflow-hidden bg-transparent border p-0"
            >
              <img class="img-fluid w-100" src="{{asset('asset/img/product-8.jpg')}}" alt="" />
            </div>
            <div
              class="card-body border-left border-right text-center p-0 pt-4 pb-3"
            >
    ...
    <div class="container-fluid pt-5">
      <div class="text-center mb-4">
        <h2 class="section-title px-5">
          <span class="px-2">Products Sale</span>
        </h2>
      </div>
      <div class="row px-xl-5 pb-3">
        <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
        ...
        <div class="col">
          <div class="owl-carousel vendor-carousel">
            <div class="vendor-item border p-4">
              <img src="{{asset('asset/img/vendor-1.jpg')}}" alt="" />
            </div>
            <div class="vendor-item border p-4">
              <img src="{{asset('asset/img/vendor-2.jpg')}}" alt="" />
            </div>
            <div class="vendor-item border p-4">
              <img src="{{asset('asset/img/vendor-3.jpg')}}" alt="" />
            </div>
            <div class="vendor-item border p-4">
              <img src="{{asset('asset/img/vendor-4.jpg')}}" alt="" />
            </div>
            <div class="vendor-item border p-4">
              <img src="{{asset('asset/img/vendor-5.jpg')}}" alt="" />
            </div>
            <div class="vendor-item border p-4">
              <img src="{{asset('asset/img/vendor-6.jpg')}}" alt="" />
            </div>
            <div class="vendor-item border p-4">
              <img src="{{asset('asset/img/vendor-7.jpg')}}" alt="" />
            </div>
            <div class="vendor-item border p-4">
              <img src="{{asset('asset/img/vendor-8.jpg')}}" alt="" />
            </div>
          </div>
        </div>
      </div>
